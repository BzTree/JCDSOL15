...
def ModifyTarget():
  ...
  while True:
    ...
    if Row > len(FilteredStudentMarks):
      print('Invalid input. Please input the correct row number. ')
      continue
    else:
      Row = Row - 1
    while True:
      ...
      if Column in ['Name', 'Surname']:
        ...
        print('Invalid input. Please input the correct column name. ')
        continue
      print(tabulate(FilteredStudentMarks, headers = 'keys', tablefmt = 'pretty'))
    ...
    while FilteredStudentMarks != StudentMarks:
      ...
      while True:
        ...
        if Filter in ['Name', 'Surname']:
          FilterList = AlphaChecker('enter the name of the student')
          for i in range(len(FilteredStudentMarks)):
...
def ChangeSchoolCode():
  ...
  SchoolCode = print(f'enter new school code')
  if regex.findall(r'-\b', SchoolCode) == []:
    SchoolCode = SchoolCode + '-'
  print(f'School code is now {SchoolCode}.')
